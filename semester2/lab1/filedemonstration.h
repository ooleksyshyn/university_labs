...
void FileDemonstration(){
    std::fstream File;

    File.open("file.txt", std::ios::app);
    File <<
    Train(1,"Bukovyna",117,"Intercity", Date(26,12,2019), Time(19,56),Date(27,12,2019)
            ,Time(7,35),0.5) << std::endl <<
    Train(2,"Kyiv",118,"International", Date(26,12,2019), Time(10,15),Date(29,12,2019)
            ,Time(23,56),0.7) << std:: endl <<
    Train(3,"Kyivshchyna",236,"Local", Date(01,01,2020), Time(10,15),Date(02,01,2020)
            ,Time(23,56),0.4) << std::endl <<
    Train(4,"Kharkiv",1,"International", Date(26,12,2019), Time(10,15),Date(29,12,2019)
            ,Time(12,40),0.8);
    File.close();
